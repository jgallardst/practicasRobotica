 ...
 *
 * Just: "${PATH_TO_BINARY}/camera --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	camera (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::camera::run(int argc, char* argv[])
{
